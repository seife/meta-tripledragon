...
##
## derived from yocto meta/recipes-core/initscripts/initscripts-1.0/populate-volatile.sh
## tripledragon has no tty0
## and reading from /proc/cmdline does not work with busybox / kernel 2.6.12
##
## Stefan Seyfried, 2013
##
...
clearcache=0
test -e /.clearcache && clearcache=1
rm -f /.clearcache
